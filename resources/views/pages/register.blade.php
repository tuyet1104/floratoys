        ...
        @csrf
           ...
           <style>
            ...
            <div class="form-group">
                ...
                <div>
                   <input type="text" name="name" class="form-control" style="font-size: 15px;">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="password" name="password" class="form-control" style="font-size: 15px;">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" name="address" class="form-control" style="font-size: 15px;">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" name="phone" class="form-control" style="font-size: 15px;">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="date" style="font-size: 15px;" class="form-control" name="ngaysinh" id="ngaysinh" required />
                </div>
            </div>
